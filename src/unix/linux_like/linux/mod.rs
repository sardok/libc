...
s! {
    ...
    pub struct posix_spawnattr_t {
        ...
        __sd: crate::sigset_t,
        __ss: crate::sigset_t,
        #[cfg(any(target_env = "fortanixvme", target_env = "musl", target_env = "ohos"))]
        __prio: c_int,
        #[cfg(not(any(target_env = "fortanixvme", target_env = "musl", target_env = "ohos")))]
    ...
    #[cfg_attr(
        any(target_env = "fortanixvme", target_env = "musl", target_env = "ohos", target_pointer_width = "32"),
        repr(align(4))
    )]
    #[cfg_attr(
        all(
...
s_no_extra_traits! {
    ...
    #[cfg_attr(
        all(
            any(target_env = "fortanixvme", target_env = "musl", target_env = "ohos"),
            target_pointer_width = "32"
        ),
        repr(align(4))
    )]
